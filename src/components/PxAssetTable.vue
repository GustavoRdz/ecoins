    ...
    <thead>
      <tr class="bg-gray-100 border-b-2 border-gray-400">
        ...
        <th :class="{ up : this.sortOrder === 1, down: this.sortOrder === -1}">
          <span class="underline cursor-pointer" @custom-click="changeSortOrder">Ranking</span>
        </th>
        <th>Nombre</th>
        <th>Precio</th>
        ...
        <td class="hidden sm:block">
          <input
            class="bg-gray-100 focus:outline-none border-b border-gray-400 py-2 px-4 block w-full appareance-none leading-normal"
            id="filter"
            placeholder="Buscar"
            type="text"
            v-model="filter"/>
